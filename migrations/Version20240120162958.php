 ...
 */
final class Version20240120162958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activities_monitors_activity (activities_monitors_id INT NOT NULL, activity_id INT NOT NULL, INDEX IDX_C2D9B9391840D73D (activities_monitors_id), INDEX IDX_C2D9B93981C06096 (activity_id), PRIMARY KEY(activities_monitors_id, activity_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE activities_monitors_activity ADD CONSTRAINT FK_C2D9B9391840D73D FOREIGN KEY (activities_monitors_id) REFERENCES activities_monitors (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE activities_monitors_activity ADD CONSTRAINT FK_C2D9B93981C06096 FOREIGN KEY (activity_id) REFERENCES activity (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activities_monitors_activity DROP FOREIGN KEY FK_C2D9B9391840D73D');
        $this->addSql('ALTER TABLE activities_monitors_activity DROP FOREIGN KEY FK_C2D9B93981C06096');
        ...
        $this->addSql('DROP TABLE activities_monitors_activity');
